...
public class Farmer extends Activity implements View.OnClickListener,View.OnLongClickListener {
    ...
    Button savebut,savebut1,tubewell,kisaaan;
    DigitalClock clock;
    ...
    private void initializeVars() {
        ...
        tubewell = (Button) findViewById((R.id.button));
        kisaaan = (Button) findViewById((R.id.button2));
        ...
        tubewell.setOnClickListener(this);
        kisaaan.setOnClickListener(this);
    ...
    String sec = null, min = null, hour = null;
        ...
        switch (v.getId()){
            ...
            case R.id.etFarmerSetAlarm53:
                ...
                break;
            case R.id.button :
                Intent i = new Intent(Farmer.this, LongRange.class);
                startActivity(i);
                break;
